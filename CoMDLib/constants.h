...
static __thread const double amuToInternalMass =
         amuInKilograms * AngsInMeters * AngsInMeters
         / (fsInSeconds * fsInSeconds  * eVInJoules);

/// Boltmann constant in eV's
static __thread const double kB_eV = 8.6173324e-5;  // eV/K

/// Hartrees to eVs
static __thread const double hartreeToEv = 27.21138505;

/// Bohrs to Angstroms
static __thread const double bohrToAngs = 0.52917721092;
