...
typedef struct CommandSt
{
  ...
  char stressSuffix[1024];	//!< suffix to append to output file containing stress tensor
  ...
  double energy;      //!< energy density from the macrosolver (same energy units as that of CoMD)
